...
!----------------------------------------------------------------------------
! Step 1 - random set of numbers
!----------------------------------------------------------------------------	
	Allocate(randomSet(1:10000))
	Do i=1,10000
	  Call RANDOM_NUMBER(randNumber)
	  randomSet(i) = randNumber
	End Do
!----------------------------------------------------------------------------
! Step 2 - store optimum potential
!----------------------------------------------------------------------------		
	...
	Call storeEAMToFile(eamKey, eamData, "tempStartOpt.pot")			!Store to file
!----------------------------------------------------------------------------
! Step 3 - calculate best rss
!----------------------------------------------------------------------------	
!Set best rss   
	eamDataSet = 1	
	Call calcEval()
