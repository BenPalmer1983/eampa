...
ELSE IF(str_compare(f_name, "bonny_density"))THEN
  CALL bonny_density_v(r, p, p_fixed, y)
...
ELSE IF(str_compare(f_name, "lagrangepoly"))THEN
  CALL lagrangepoly_v(r, p, p_fixed, y)
...
ELSE IF(str_compare(f_name, "polynomial_embedding"))THEN
  CALL polynomial_embedding_v(r, p, p_fixed, y)
...
ELSE IF(str_compare(f_name, "spline_density"))THEN
  CALL spline_density_v(r, p, p_fixed, y)
