...
INCLUDE "fnc.bonny_density.f90"
INCLUDE "fnc.bonny_density_grad.f90"
...
INCLUDE "fnc.lagrangepoly.f90"
!INCLUDE "fnc.lagrangepoly_grad.f90"
...
INCLUDE "fnc.polynomial_embedding.f90"
INCLUDE "fnc.polynomial_embedding_grad.f90"
INCLUDE "fnc.slater_4s.f90"
INCLUDE "fnc.slater_4s_grad.f90"
INCLUDE "fnc.spline.f90"
INCLUDE "fnc.spline_grad.f90"
INCLUDE "fnc.spline_density.f90"
INCLUDE "fnc.spline_density_grad.f90"
