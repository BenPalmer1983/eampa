...
class rss:
  ...
  def run():
    ...
    for n in range(len(g.bp)):
      output.log("{0:20s}{1:4d}".format("BP id:",n), verbose=0)
      output.log("{0:20s}{1:12.6f}".format("a0 rss:",g.bp[n]['rss_details']['a0']), verbose=0)
      output.log("{0:20s}{1:12.6f}".format("e0 rss:",g.bp[n]['rss_details']['e0']), verbose=0)
      output.log("{0:20s}{1:12.6f}".format("b0 rss:",g.bp[n]['rss_details']['b0']), verbose=0)
      output.log("{0:20s}{1:12.6f}".format("ec rss:",g.bp[n]['rss_details']['ec']), verbose=0)
      output.log("{0:20s}{1:12.6f}".format("rose rss:",g.bp[n]['rss_details']['rose']), verbose=0)
      output.log("{0:20s}{1:12.6f}".format("msp shape rss:",g.bp[n]['rss_details']['msp_shape']), verbose=0)
      output.log("{0:20s}{1:12.6f}".format("msp values rss:",g.bp[n]['rss_details']['msp_values']), verbose=0)
      output.log("{0:20s}{1:12.6f}".format("bm eos shape rss:",g.bp[n]['rss_details']['bm_eos_shape']), verbose=0)
      output.log("{0:20s}{1:12.6f}".format("bm eos values rss:",g.bp[n]['rss_details']['bm_eos_values']), verbose=0)
      output.log("{0:20s}{1:12.6f}".format("penalty rss:",g.bp[n]['rss_details']['bp_penalty']), verbose=0)
      output.log("{0:20s}{1:12.6f}".format("total rss:",g.bp[n]['rss']), verbose=0)
