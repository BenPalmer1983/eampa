...
!Calculate starting RSS
	...
	print *,"Starting RSS:",trialResidualSquareSum  !Starting RSS
    print *,"Starting Wobbliness:",wobbliness  !Starting RSS
    print *,"Starting Curve Length:",curveLengthValue  !Starting RSS
