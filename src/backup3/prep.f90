...
!calculated values
  ...
  Real(kind=DoubleReal), Dimension( : , : ), Allocatable :: configurationEC
  ...
  Real(kind=DoubleReal), Dimension( : ), Allocatable :: configurationEquVolume
  Real(kind=DoubleReal), Dimension( : ), Allocatable :: configurationEquLat
...
!Reference energies, forces, stresses etc  
  ...
  Real(kind=DoubleReal), Dimension( : , : ), Allocatable :: configurationRefEC
  Real(kind=DoubleReal), Dimension( : ), Allocatable :: configurationRefEquVolume
