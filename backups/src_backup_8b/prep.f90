...
!	
	If(pointToVary.gt.0.and.varyAmount.ne.0.0D0)Then
	  ...
	  !If(mpiProcessID.eq.0)Then
	  !print *,eamDataReducedArray(pointToVary,2)
	  !End If
	  Call storeEAMToFile(eamKeyReducedArray, eamDataReducedArray, "pottest1.pot")
	  eamDataReducedArray = VaryPoints(eamDataReducedArray,varyAmount,pointToVary)
	  Call storeEAMToFile(eamKeyReducedArray, eamDataReducedArray, "pottest2.pot")
	  
	  !If(mpiProcessID.eq.0)Then
	  !print *,varyAmount,pointToVary,eamDataReducedArray(pointToVary,2)
	  !print *,""
	  !End If
    End If	
!
